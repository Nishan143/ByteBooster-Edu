    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                ...
                <a href="contact.php" class="btn btn-primary py-2 px-4 d-none d-lg-block">Join Us</a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
                        ...
                        <div class="courses-text">
                            ...
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <!-- Replaced instructor name with Enroll button -->
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    ...
                    <p class="m-0">Our students excel at organizing tasks, working in teams, and meeting deadlines with
                        responsibility. Their adaptability, problem-solving mindset, and clear communication make them
                        well-prepared for real-world projects.</p>
                </div>
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel">
                        ...
                        <div class="bg-white p-5">
                            ...
                            <p>The course provides a solid foundation in HTML, CSS, JavaScript, and modern frameworks.
                                ...
                                it very effective for beginners and career starters.</p>
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                <img class="img-fluid mr-4" src="img/titly.jpeg" alt="">
                                <div>
                                    <h5>Sadia Alam titly</h5>
                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="mt-n1">
                                <h4>Our Location</h4>
                                <p class="m-0">City Centre, 90/1 Motijheel C/A, Dhaka 1000, Bangladesh</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-5">
                            <div class="btn-icon bg-secondary mr-4">
